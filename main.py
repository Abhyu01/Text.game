...
def goblin():
    user_choice_goblin = input(f"""You have encountered a random goblin!, Its not here for your money, its here for your life!
     I dont think you have more options rather than escape and attack, make your move {user_name}! Please enter a valid option
     escape or attack: """)
...
def ogre():
    user_choice_orgre = input(f"""You have stumbled upon an orgre! this beast is tall and vicious, but lucky you, its sleeping rigt now,
    you have a choice to kill it silently or evade it slowly? what will you do? kill or evade? Please enter a valid choice:  """)
    while user_choice_orgre not in ["evade", "kill"]:
        print("Invalid value, please enter a relevant one.")
        user_choice_orgre = input(f"""You have stumbled upon an orgre! this beast is tall and vicious, but lucky you, its sleeping rigt now,
    you have a choice to kill it silently or evade it slowly? what will you do? kill or evade? Please enter a valid choice:  """)
    if user_choice_orgre == "kill":
        return print("You silently killed the ogre with your sword, you have gotten stronger!")
    elif user_choice_orgre == "evade":
        return print("You successfully evaded the ogre! Your intellect has risen!")
    else:
        return print("Invalid value, please enter a relevant one.")

def orc():
    user_choice_orc = input(f"""You ran into an orc! These beasts are strong but quite dumb, if you wish to fight it, you should fight it with
    with intelligence. Or you could wish to evade it too. What's your choice? attack or evade?: """)
...
def mini_orc():
    user_choice_miniorc = input(f"""You ran into an orc! But this one is a bit small comparing to an orc. Orcs are strong but dumb, If you wish to fight
    it, fight it with intelligence! Or you could choose to evade it aswell. attack or evade?: """)
    while user_choice_miniorc not in ["attack", "evade"]:
        print("Invalid value, please enter a relevant one.")
        user_choice_miniorc = input(f"""You ran into an orc! But this one is a bit small comparing to an orc. Orcs are strong but dumb, If you wish to fight
    it, fight it with intelligence! Or you could choose to evade it aswell. attack or evade?: """)
    if user_choice_miniorc == "attack":
        return print("You fought the mini orc, it was pretty strong but you came out on top. Your strength and intellect have risen.")
    elif user_choice_miniorc == "evade":
...
def royal_guard_1():
    ...
    while user_choice_guard1 not in ["Candle", "candle", "a candle"]:
        guesscount1 += 1
        print(f"Wrong answer! {guesscount1} try gone. You have 5 in total")
        user_choice_guard1 = input("Try again. ")
        if guesscount1 == 5:
            return print("You have died trying to defeat a royal guard. Game Over.")
        exit()
    else:
        return print("You killed a royal guardian orc in your ", guesscount1 ,"th try!")
...
def royal_guard_2():
    ...
    while user_choice_guard2 not in ["dictionary", "Dictionary", "a dictionary"]:
        guesscount2 +=1
        print(f"Wrong answer! {guesscount2} try gone. You have 5 in total.")
        user_choice_guard2 = input("Try again. ")
    if guesscount2 == 5:
        return print("You have died trying to defeat a royal guard. Game over.")
        exit()
    else:
        return print("You killed the 2nd royal guardian orc in your", guesscount2,"th try!")
...
def royal_guard_3():
    ...
    while user_choice_guard3 not in ["Mercury" "mercury"]:
        guesscount3 += 1
        print(f"Wrong answer! {guesscount3} try gone, you have 5 in total.")
        user_choice_guard3 = input("Try again. ")
    if guesscount3 == 5:
        return print("You died trying to defeat a royal guard. Game over.")
        exit()
    else:
        return print("You kill the 3rd royal guardian orc in your", guesscount3,"th try!" )
...
def royal_guard_4():
    ...
    while user_choice_guard4 not in ["footsteps", "Footsteps", "Your footsteps"]:
        guesscount4 += 1
        print(f"""Wrong answer! {guesscount4} try gone. You have 5 in total.""")
        user_choice_guard4 = input("Try again. ")
    if user_choice_guard4 == 5:
        print("You died trying to fight a royal guard. Game over.")
        exit()
    else:
        print(f"You defeated the 4th royal guardian orc in your {guesscount4}th try!")

def royal_guard_5():
    guesscount5 = 0
    user_choice_guard5 = input(f"""Prepare to take on the 5th royal guard!
    I am the beginning of everything, the end of everywhere. I’m the beginning of eternity, the end of time and space. What am I? 
     """)
    while user_choice_guard5 not in ["e", "letter e", "the letter e"]:
        guesscount5 += 1
        print(f"Wrong answer! {guesscount5} try gone. You have 5 in total.")
        user_choice_guard5 = input("Try again. ")
    if guesscount5 == 5:
        return print("You died trying to defeat a royal guard. Game over.")
        exit()
    else:
        return print(f"You killed the 5th royal guard in your {guesscount5}th try!")

def royal_guard_6():
    guesscount6 = 0
    user_choice_guard6 = input(f"""One last guard left, then you can reach the orc lord. I pray for your victory {user_name}! 
    If you have me, you want to share me. If you share me, you haven’t got me. What am I? 
    """)
    while user_choice_guard6 not in ["Secret", "secret", "a secret"]:
        guesscount6 += 1
        print(f"Wrong answer! {guesscount6} try gone. You have 5 in total.")
        user_choice_guard6 = input("Try again. ")
    if guesscount6 == 5:
        return print("You died trying to defeat a royal guard. Game over.")
        exit()
    else:
        return print(f"You killed the last royal guard in your{guesscount6}th try! Now you have to face the Orc lord!")

def orc_lord():
    guesses = 0
    user_choice_lord = input(f"""The Orc lord accepts your duel request. He is known as the most powerful being in the the terminal word. May you
    be victorious {user_name}
    If you have me, you want to share me. If you share me, you haven’t got me. What am I? 
     """)
...
user_role = (input(f"""Welcome {user_name} to the world of the Terminal! Here you will have to choose a role
between a warrior, an adventurer, and a researcher.what role do you want? a warrior? an adventurer? or a researcher? Enter a valid role: """))
...
you stayed as a traveler in villages and while you conversed with villagers, you found out other people have also gotten
randomly summoned in the terminal world. The villagers call them 'fallen heroes' and they still pray that one day they will get freed.""")
...
print("""6 months have passed, you still havent found anything useful, you are slowly starting to loose hope

 """)

print("""It has been a whole year, yet you failed to find anyting meaningful, you clueless on why you're still trying to free this world

""")

print(f"""Jackpot! while you were traveling you found an orc castle! This might just be your ticket out of the terminal world.

""")

print(f"""You see alot of miniorcs, wolves, goblins and ogres defending the castle. Get ready for a massive fight 
...
print(f"""You cleared the the defenders. You head inside the orc castle to the throne room, and then you see 6 big orcs and then another orc wearing
a crown. Your mission is to kill the orc in the crown. To get to him, you need to fight his royal guards """)
